...
class IterateeSpec extends FlatSpec with Matchers with Instrumented {
  ...
  "TFree Iteratee" should "work" in {
    ...
    testTime("TFree 2000") { println(testQuadratic(2000)) }
    testTime("TFree 3000") { println(testQuadratic(3000)) }
    testTime("TFree 4000") { println(testQuadratic(4000)) }
    testTime("TFree 5000") { println(testQuadratic(5000)) }
    testTime("TFree 10000") { println(testQuadratic(10000)) }

  }

  "Basic Free Iteratee" should "work" in {
    import BasicFreeTest._
    import It._

    def testQuadratic(n: Int) = feedAll(addNbad(n))(1 to n)

    testTime("BasicFree 1000") { println(testQuadratic(1000)) }
    testTime("BasicFree 2000") { println(testQuadratic(2000)) }
    testTime("BasicFree 3000") { println(testQuadratic(3000)) }
    testTime("BasicFree 4000") { println(testQuadratic(4000)) }
    testTime("BasicFree 5000") { println(testQuadratic(5000)) }
    testTime("BasicFree 10000") { println(testQuadratic(10000)) }
...
*/
  ...
  "Free Iteratee" should "Iteratee" in {
    ...
    testTime("Scalaz Free 1000") { println(testQuadratic(1000)) }
    testTime("Scalaz Free 2000") { println(testQuadratic(2000)) }
    testTime("Scalaz Free 3000") { println(testQuadratic(3000)) }
    testTime("Scalaz Free 4000") { println(testQuadratic(4000)) }
    testTime("Scalaz Free 5000") { println(testQuadratic(5000)) }
    testTime("Scalaz Free 10000") { println(testQuadratic(10000)) }
